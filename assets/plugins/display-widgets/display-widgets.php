...
<div style="height:150px; overflow:auto; border:1px solid #dfdfdf; padding:5px; margin-bottom:5px;">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php _e('Pages', 'Evyr2014') ?> +/-</h4>
    <div class="dw_collapse">
    ...
    <h4 class="dw_toggle" style="cursor:pointer;"><?php _e('Categories', 'Evyr2014') ?> +/-</h4>
    <div class="dw_collapse">
...
<?php
    ...
    function page_types(){
        $page_types = array(
            ...
            'archive'   => __('Archives', 'Evyr2014'),
            'single'    => __('Single Post', 'Evyr2014'),
            '404'       => '404',
            'search'    => __('Search', 'Evyr2014'),
        );
